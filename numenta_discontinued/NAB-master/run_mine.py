...
def main(args):
  ...
  if args.detect:
    ...
    print("Total time for classification in milliseconds " + str(int(delta.total_seconds() * 1000)) +'\n')
...
if __name__ == "__main__":
  ...
  if "my" in args.detectors:
    from nab.detectors.my_detector.my_detector import MyDetector

  if "myadwin" in args.detectors:
    from nab.detectors.my_adwin.adwin import MyadwinDetector
